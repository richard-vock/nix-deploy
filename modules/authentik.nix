...
let
  ...
  # cachetools is missing from the packaged authentik runtime, so add it manually
  cachetoolsPath = "${pkgs.python3Packages.cachetools}/${pkgs.python3Packages.python.sitePackages}";
in
with lib;
{
